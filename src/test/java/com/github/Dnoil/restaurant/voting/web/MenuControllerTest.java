...
public class MenuControllerTest extends AbstractControllerTest {
    private static final String MENUS_URL = "/admin/menus";
    ...
    void getAll() throws Exception {
        perform(MockMvcRequestBuilders.get(MENUS_URL + "/old/restaurant?id=" + RESTAURANT_ID))
                ...
                .andDo(print())
                .andExpect(content().contentTypeCompatibleWith(MediaType.APPLICATION_JSON))
                .andExpect(MENU_MATCHER.contentJson(allMenusOfFirstRestaurant));
    }
    ...
    void update() throws Exception {
        ...
        perform(MockMvcRequestBuilders.put(MENUS_URL + "/" + MENU_ID)
                ...
                .andExpect(status().isNoContent());
        MENU_MATCHER.assertMatch(menuService.getActual(RESTAURANT_ID), updated);
    }
    ...
    void createWithLocation() throws Exception {
        ...
        MENU_MATCHER.assertMatch(menuService.getActual(newRestaurant.id()), newMenu);
    }
}
