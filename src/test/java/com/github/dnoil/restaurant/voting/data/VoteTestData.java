...
public class VoteTestData {
    ...
    public static final Vote oldVote = new Vote(OLD_VOTE_ID, UserTestData.user1, RestaurantTestData.restaurant2);
    ...
    public static Vote getNew() {
        return new Vote((Integer) null, UserTestData.admin, RestaurantTestData.restaurant1);
    }
}
